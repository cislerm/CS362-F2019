//assgn2 from teammate 11/22/19
//start compiling his code, run unit tests assgn 3, run random tests assgn4, look at output,
//take screenshots, redo makefile
//unittests from assgn3 work now trying randomtests from assgn4
//make new functions for randomtests
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	case baron:
		//return baronEffect(state, currentPlayer, choice1); //original
		return baronEffect(card, choice1, state, handPos, currentPlayer); //assgn3,5
    ...
    case minion:
        //return minionEffect(choice1, choice2, state, handPos);
		//added in for assgn5
    ...
    case ambassador:
       //changed from assgn5
	   //return ambassadorEffect(choice1, choice2, state, handPos);
...
//int baronEffect(int choice1, struct gameState *state) //original
//change for unittest1
int baronEffect(int card, int choice1, struct gameState *state, int handPos, int currentPlayer){ //Assgn3,5
        ...
        while(card_not_discarded){
            if (state->hand[currentPlayer][p] == estate){ //Found an estate card!
                ...
                if (supplyCount(estate, state) > 0) {
					...
					//added back in for assgn5 bc core kept dumping
					//if (supplyCount(estate, state) == 0){
                         //isGameOver(state);
                    }
                }
...
int ambassadorEffect(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2)
{
    ...
    for (i = 0; i < state->handCount[currentPlayer]; i++)
    {
		//assgn5 updated code so function runs
